...
class __TwigTemplate_fe2deb1dfad58be5d9f2e4b41c019a1e4d5c2ee8eb5331fdf60909546dd4a2ac extends \Twig\Template
{
...
($context["settings"] ?? null), "thumbnail_position", []))) ? (("slick-wrapper--tn-" . twig_replace_filter($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["settings"] ?? null), "thumbnail_position", [])), ["over-" => ""]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "modules/contrib/slick/templates/slick-wrapper.html.twig", "/home/ubuntu/sites/qrida-website/docroot/modules/contrib/slick/templates/slick-wrapper.html.twig");
    }
}
