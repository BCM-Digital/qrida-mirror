...
/* @govcms8_uikit_starter/inc/list.twig */
class __TwigTemplate_01464bca41b6d68c869511c525f36b19caad87f7295b0d05c5f7bad373612d72 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $filters = ["clean_class" => 28, "round" => 41, "length" => 41, "replace" => 44, "escape" => 49];
        $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if', 'for'],
                ['clean_class', 'round', 'length', 'replace', 'escape'],
                []
            );
...
";
        ...
        if ((twig_length_filter($this->env, ($context["items"] ?? null)) > 4)) {
            // line 44
            echo "  ";
            $context["items_grid"] = twig_replace_filter((12 / twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["items"] ?? null)))), ["." => "-"]);
        }
        // line 46
        echo "
";
        // line 47
        $context["grid_cols"] = (((twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["items"] ?? null))) > 4)) ? (("col-xs-12 col-sm-4 col-md-" . $this->sandbox->ensureToStringAllowed(($context["items_grid"] ?? null)))) : (("col-xs-12 col-sm-" . $this->sandbox->ensureToStringAllowed(($context["items_grid"] ?? null)))));
        // line 48
        echo "
<div ";
        // line 49
...
";
    ...
    {
        return "@govcms8_uikit_starter/inc/list.twig";
    }
    ...
    {
        return new Source("", "@govcms8_uikit_starter/inc/list.twig", "/home/ubuntu/sites/qrida-website/docroot/themes/custom/govcms8_uikit_starter/templates/inc/list.twig");
    }
}
