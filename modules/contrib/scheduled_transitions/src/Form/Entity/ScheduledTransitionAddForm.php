...
class ScheduledTransitionAddForm extends ContentEntityForm {
  ...
  public static function create(ContainerInterface $container) {
    ...
    $instance->moderationInformation = $container->get(ModerationInformationInterface::class);
    $instance->stateTransitionValidation = $container->get(StateTransitionValidationInterface::class);
    $instance->languageManager = $container->get(LanguageManagerInterface::class);
    $instance->scheduledTransitionsUtility = $container->get(ScheduledTransitionsUtilityInterface::class);
